...
- u55c, generic, EmuUdp, 1KB buf: stuck at Broadcast(1536)
- u55c, generic, EmuUdp, 4KB buf: long setup, passes Broadcast(1536, stuck at AlltoAll(1536)
- u55c, generic, EmuCytRdma, 4KB buf: long setup, works fine, still slow